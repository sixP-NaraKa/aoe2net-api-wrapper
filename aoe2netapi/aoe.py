...
# request api base urls, modifiable (by the corresponding function) via __str__.format()
ab_strings = API_BASE + "/strings?game={}"
ab_leaderboard = API_BASE + "/leaderboard?" \
                            "game=aoe2de&leaderboard_id={}&start={}&count={}&search={}&steam_id={}&profile_id={}"
ab_lobbies = API_BASE + "/lobbies?game={}"
ab_last_match = API_BASE + "/player/lastmatch?game=aoe2de&steam_id={}profile_id={}"
ab_match_history = API_BASE + "/player/matches?game=aoe2de&start={}&count={}&steam_id={}&profile_id={}"
ab_rating_history = API_BASE + "/player/ratinghistory?" \
                               "game=aoe2de&leaderboard_id={}&start={}&count={}&steam_id={}&profile_id={}"
ab_matches = API_BASE + "/matches?game=aoe2de&count={}&since={}"
ab_match = API_BASE + "/match?uuid={}&match_id={}"
ab_numbers_online = API_BASE + "/stats/players?game={}"

# request nightbot api base urls, modifiable (by the corresponding function) via __str__.format()
nb_rank_details = NIGHTBOT_BASE + "/rank?leaderboard_id={}&flag=false&search={}&steam_id={}&profile_id={}"
nb_recent_opponent = NIGHTBOT_BASE + "/opponent?leaderboard_id={}&flag=false&search={}&steam_id={}&profile_id={}"
nb_current_match = NIGHTBOT_BASE + "/match?leaderboard_id={}&color={}&flag=false&search={}&steam_id={}&profile_id={}"
nb_current_civs = NIGHTBOT_BASE + "/civs?leaderboard_id={}&search={}&steam_id={}&profile_id={}"
nb_current_map = NIGHTBOT_BASE + "/map?leaderboard_id={}&search={}&steam_id={}&profile_id={}"
...
def _get_request_response(link: str, json: bool = True):
    """
...
def ab_get_strings(game: str = "aoe2de", json: bool = True):
    ...
    api = ab_strings.format(game)
    return _get_request_response(link=api, json=json)
...
def ab_get_leaderboard(leaderboard_id: int = 3, start: int = 1, count: int = 10, json: bool = True, **kwargs):
    ...
    **kwargs : `dict`
    ...
    api = ab_leaderboard.format(leaderboard_id,
                                start,
                                count,
                                optionals.get("search").replace(" ", "+"),
                                optionals.get("steam_id"),
                                optionals.get("profile_id"))

    return _get_request_response(api, json=json)
...
def ab_get_last_match(steam_id: str, profile_id: str = "", json: bool = True):
    ...
    api = ab_last_match.format(steam_id, profile_id)
    return _get_request_response(link=api, json=json)
...
def ab_get_match_history(start: int = 0, count: int = 5, steam_id: str = "", profile_id: str = "", json: bool = True):
    ...
    api = ab_match_history.format(start, count, steam_id, profile_id)
    return _get_request_response(link=api, json=json)
...
def ab_get_rating_history(leaderboard_id: int = 3, start: int = 0, count: int = 100, steam_id: str = "", profile_id: str = "", json: bool = True):
    ...
    api = ab_rating_history.format(leaderboard_id, start, count, steam_id, profile_id)
    return _get_request_response(link=api, json=json)
...
def ab_get_matches(count: int = 5, json: bool = True, **kwargs):
    ...
    **kwargs : `dict`
    ...
    api = ab_matches.format(count, optionals.get("since"))
    return _get_request_response(link=api, json=json)
...
def ab_get_match(uuid: str, match_id: str = "", json: bool = True):
    ...
    api = ab_match.format(uuid, match_id)
    return _get_request_response(link=api, json=json)
...
def ab_get_num_online(json: bool = True):
    ...
    api = ab_numbers_online.format("aoe2de")
    return _get_request_response(link=api, json=json)
...
def nb_get_rank_details(search: str = "", steam_id: str = "", profile_id: str = "", **kwargs):
    ...
    **kwargs : `dict`
    ...
    api = nb_rank_details.format(optionals.get("leaderboard_id"), search.replace(" ", "+"), steam_id, profile_id)
    return _get_request_response(link=api, json=False).text
...
def nb_get_recent_opp(search: str = "", steam_id: str = "", profile_id: str = "", **kwargs):
    ...
    **kwargs : `dict`
    ...
    api = nb_recent_opponent.format(optionals.get("leaderboard_id"), search, steam_id, profile_id)
    return _get_request_response(link=api, json=False).text
...
def nb_get_current_match(search: str = "", steam_id: str = "", profile_id: str = "", **kwargs):
    ...
    **kwargs : `dict`
    ...
    api = nb_current_match.format(optionals.get("leaderboard_id"), optionals.get("color").__str__().lower(),
...
def nb_get_current_civs(search: str = "", steam_id: str = "", profile_id: str = "", **kwargs):
    ...
    **kwargs : `dict`
    ...
    api = nb_current_civs.format(optionals.get("leaderboard_id"), search.replace(" ", "+"), steam_id, profile_id)
    return _get_request_response(link=api, json=False).text
...
def nb_get_current_map(search: str = "", steam_id: str = "", profile_id: str = "", **kwargs):
    ...
    **kwargs : `dict`
    ...
    api = nb_current_map.format(optionals.get("leaderboard_id"), search.replace(" ", "+"), steam_id, profile_id)
    return _get_request_response(link=api, json=False).text
